...
if(isset($_POST[submit]))
{
	...
	{
$sql="INSERT INTO `city`(`city_id`, `country_id`, `state_id`, `city`, `description`, `status`) VALUES (NULL,'$_POST[country]','$_POST[state]','$_POST[city]','$_POST[description]','$_POST[status]')";	
if(!mysqli_query($con,$sql))
	{
