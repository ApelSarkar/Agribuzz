...
if(isset($_POST[submit]))
{
	...
	{
		$sql="INSERT INTO worker(worker_id, name, address, state_id, city_id, country_id, pincode, contactno, work_profile, biodata, date_of_birth, login_id, password, expected_salary, status) VALUES (NULL,'$_POST[name]','$_POST[address]','$_POST[state]','$_POST[city]','$_POST[country]','$_POST[pincode]','$_POST[contct]','$_POST[workprofile]','$imgname1','$_POST[dob]','$_POST[loginid]','$_POST[password]','$_POST[expectedsalary]','Active')";
		if(!mysqli_query($con,$sql))
			{
				echo "Error in mysqli query";
			}
