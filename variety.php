...
if(isset($_POST[submit]))
{
	...
	{
$sql="INSERT INTO `variety`(`variety_id`, `category_id`, `produce_id`, `variety`, `description`, `img`, `status`) VALUES (NULL,'$_POST[category]','$_POST[produce]','$_POST[variety]','$_POST[description]','$imgname1','Active')";
if(!mysqli_query($con,$sql))
	{
		echo "Error in mysqli query";
	}
